...
if __name__ == "__main__":
    ...
    target = args.target if args.target in ["default", "HVN", "SP", "ABSEHVMEANNORM", "ABSEHVAUCMEANNORM", "ABSECUMHVMEANNORM", "ABSECUMHVAUCMEANNORM"] else "default"
    ...
    for solver in solvers:
        ...
        for instance in instances:
            ...
            command = f"sbatch ../02validation/validation.py --instance {instance_path} --solver {solver_path} --runs 25 --output {output_path} {configarg}"
            print(command)
            os.system(command)